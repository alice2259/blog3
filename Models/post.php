    ...
    public static function search() {
      ...
      $db = Db::getInstance();
        ...
        if(isset($_POST['search'])){
            ...
            $sql = "SELECT DISTINCT post.postID, post.title, post.datePublished, post.headerImage, post.imageCaption, post.content, userTable.profilePic, userTable.firstName, userTable.surname FROM post "
            ...
            . "UNION "
            . "SELECT DISTINCT post.postID, post.title, post.datePublished, post.headerImage, post.imageCaption, post.content, userTable.profilePic, userTable.firstName, userTable.surname FROM post "
            . "INNER JOIN userTable ON post.userID=userTable.userID "  
            . "INNER JOIN post_Tag ON post.postID=post_Tag.postID " 
            . "INNER JOIN tag ON post_Tag.tagID=tag.tagID " 
